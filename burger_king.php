    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="burger_king.php"</script>';
            }else{
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="buger_king_style.css">
...
<body>
    ...
    <div class="container" style="width: 70%">
        <h2>Burger kings food menu</h2>
        <?php
            $query = "SELECT * FROM burger_kings_menu ORDER BY id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="burger_king?action=add&id=<?php echo $row["id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="burger_king?action=delete&id=<?php echo $value["food_id"]; ?>"><span
