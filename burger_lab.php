    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="burger_lab.php"</script>';
            }else{
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="burger_lab_style.css">
...
<body>
    ...
    <div class="container" style="width: 70%">
        <h2>Burger Lab food menu</h2>
        <?php
            $query = "SELECT * FROM burger_lab_menu ORDER BY id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="burger_lab?action=add&id=<?php echo $row["id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="burger_lab?action=delete&id=<?php echo $value["food_id"]; ?>"><span
