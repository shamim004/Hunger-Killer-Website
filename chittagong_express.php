    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="chittagong_express.php"</script>';
            }else{
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="chittagong_express_style.css">
...
<body>
    ...
    <div class="container" style="width: 70%">
        <h2>Chittagong Express food menu</h2>
        <?php
            $query = "SELECT * FROM chittagong_express_menu ORDER BY id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="chittagong_express?action=add&id=<?php echo $row["id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="chittagong_express?action=delete&id=<?php echo $value["food_id"]; ?>"><span
